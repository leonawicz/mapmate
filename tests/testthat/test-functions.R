...
test_that("project_to_hemisphere returns valid output", {
  expect_is(project_to_hemisphere(0,0,0,0), "tbl_dt")
  expect_is(project_to_hemisphere(0,0,0,0), "tbl")
  expect_is(project_to_hemisphere(0,0,0,0), "data.table")
  ...
  expect_is(project_to_hemisphere(-180:180, seq(-90, 90, length.out=361), 40, -60), "tbl_dt")
