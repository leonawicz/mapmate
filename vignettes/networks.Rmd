...
---
  ...
  <!-- networks.md is generated from networks.Rmd. Please edit that file -->
  
```{r, echo = FALSE}
knitr::opts_chunk$set(cache = FALSE, eval = F, collapse = TRUE, comment = ">", fig.path="README-Network-",
  message = F, warning = F, error = F, tidy = T)
```
...
<p style="text-align:center;"><img src="network2D.gif"></p>
...
<p style="text-align:center;"><img src="network3D.gif"></p>
